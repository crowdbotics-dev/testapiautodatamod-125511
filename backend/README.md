...
## Project Structure
    ...
    ├── testapiautodatamod_125511  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_125511`
...
2. Clone this repo and `cd testapiautodatamod_125511`
